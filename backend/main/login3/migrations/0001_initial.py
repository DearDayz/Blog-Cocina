# Generated by Django 5.1.1 on 2024-10-07 01:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cedula', models.IntegerField(unique=True, validators=[login3.validadores.validador_user.validar_cedula], verbose_name='cedula')),
                ...
                ('telefono', models.BigIntegerField(unique=True, validators=[login3.validadores.validador_user.validar_telefono], verbose_name='telefono')),
